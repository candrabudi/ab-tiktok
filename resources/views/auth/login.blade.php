...
<!-- Mirrored from midone-html.vercel.app/enigma-side-menu-login-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Jun 2024 06:57:21 GMT -->
<!-- Added by HTTrack -->
                    ...
                    <div class="flex flex-col">
                            ...
                            <div class="mt-5 grid grid-cols-2 gap-x-5 gap-y-3.5">
                                    ...
                                    <a href="rubick-side-menu-dashboard-overview-1-page.html"
                                        ...
                                        <div class="image-fit h-full w-full overflow-hidden rounded-md">
                                            <img class="h-full w-full"
                                                src="{{ asset('dist/images/themes/rubick.png') }}"
                                ...
                                <div>
                                    <a href="icewall-side-menu-dashboard-overview-1-page.html"
                                        ...
                                        <div class="image-fit h-full w-full overflow-hidden rounded-md">
                                            <img class="h-full w-full"
                                                src="{{ asset('dist/images/themes/icewall.png') }}"
                                                alt="Midone - Admin Dashboard Template">
                                        </div>
                                    </a>
                                    <div class="mt-2.5 text-center text-xs capitalize">
                                ...
                                <div>
                                    <a href="tinker-side-menu-dashboard-overview-1-page.html"
                                        ...
                                        <div class="image-fit h-full w-full overflow-hidden rounded-md">
                                            <img class="h-full w-full"
                                                src="{{ asset('dist/images/themes/tinker.png') }}"
                                                alt="Midone - Admin Dashboard Template">
                                        </div>
                                    </a>
                                    <div class="mt-2.5 text-center text-xs capitalize">
                                ...
                                <div>
                                    <a href="enigma-side-menu-dashboard-overview-1-page.html"
                                        ...
                                        <div class="image-fit h-full w-full overflow-hidden rounded-md">
                                            <img class="h-full w-full"
                                                src="{{ asset('dist/images/themes/enigma.png') }}"
                                                alt="Midone - Admin Dashboard Template">
                                        </div>
                                    </a>
                                    <div class="mt-2.5 text-center text-xs capitalize">
                        ...
                        <div class="px-8 pb-8 pt-6">
                            ...
                            <div class="mt-5 grid grid-cols-3 gap-x-5 gap-y-3.5">
                                <div>
                                    <a href="enigma-side-menu-dashboard-overview-1-page.html"
                                        ...
                                        <div class="h-full w-full overflow-hidden rounded-md">
                                            <img class="h-full w-full"
                                                src="{{ asset('dist/images/layouts/side-menu.png') }}"
                                                alt="Midone - Admin Dashboard Template">
                                        </div>
                                    </a>
                                    <div class="mt-2.5 text-center text-xs capitalize">
                                ...
                                <div>
                                    <a href="enigma-simple-menu-dashboard-overview-1-page.html"
                                        class="h-24 cursor-pointer bg-slate-50 box p-1 block">
                                        <div class="h-full w-full overflow-hidden rounded-md">
                                            <img class="h-full w-full"
                                                src="{{ asset('dist/images/layouts/simple-menu.png') }}"
                                                alt="Midone - Admin Dashboard Template">
                                        </div>
                                    </a>
                                    <div class="mt-2.5 text-center text-xs capitalize">
                                ...
                                <div>
                                    <a href="enigma-top-menu-dashboard-overview-1-page.html"
                                        class="h-24 cursor-pointer bg-slate-50 box p-1 block">
                                        <div class="h-full w-full overflow-hidden rounded-md">
                                            <img class="h-full w-full"
                                                src="{{ asset('dist/images/layouts/top-menu.png') }}"
                                                alt="Midone - Admin Dashboard Template">
                                        </div>
                                    </a>
                                    <div class="mt-2.5 text-center text-xs capitalize">
                ...
                <div class="hidden min-h-screen flex-col xl:flex">
                    ...
                    <div class="my-auto">
                        ...
                        <div class="-intro-x mt-5 text-lg text-white text-opacity-70 dark:text-slate-400">
                            Kelola semua akun social media Anda di satu tempat.
                        </div>
                    </div>
                </div>
                ...
                <div class="my-10 flex h-screen py-5 xl:my-0 xl:h-auto xl:py-0">
                    <div
                        ...
                        <div class="intro-x mt-2 text-center text-slate-400 xl:hidden">
                            Beberapa klik lagi untuk masuk ke akun Anda. Kelola semua akun Social Media Anda di satu tempat.
                        </div>
